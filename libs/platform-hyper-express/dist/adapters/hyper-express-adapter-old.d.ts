 ...
 * @publicApi
 */
export declare class HyperExpressAdapter extends AbstractHttpAdapter<http.Server | https.Server> {
    private readonly routerMethodFactory;
    private readonly logger;
    private readonly openConnections;
    private readonly hyperExpress;
    ...
    useBodyParser<Options = NestHyperExpressBodyParserOptions>(type: NestHyperExpressBodyParserType, rawBody: boolean, options?: Omit<Options, 'verify'>): this;
