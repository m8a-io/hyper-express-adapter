...
import type { Server as HyperExpressServer, Request, Response } from 'hyper-express';
 ...
 * @publicApi
 */
export interface NestHyperExpressApplication<TServer extends CoreHttpServer | CoreHttpsServer = CoreHttpServer> extends INestApplication<TServer> {
    /**
     * Returns the underlying HTTP adapter bounded to the hyper-express app.
     *
     * @returns {HttpServer}
     */
    getHttpAdapter(): HttpServer<Request, Response, HyperExpressServer>;
    /**
     ...
     * @returns {this}
     */
    useBodyParser<Options = NestHyperExpressBodyParserOptions>(parser: NestHyperExpressBodyParserType, options?: Omit<Options, 'verify'>): this;
    /**
