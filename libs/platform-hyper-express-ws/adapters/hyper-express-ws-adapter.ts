 ...
 * @publicApi
 */
export class HyperExpressWsAdapter extends AbstractWsAdapter {
  protected readonly logger = new Logger(HyperExpressWsAdapter.name);
  ...
  constructor(appOrHttpServer?: INestApplicationContext | any) {
    ...
    HyperExpress = loadPackage('hyper-express', 'HyperExpressWsAdapter', () => require('hyper-express'));
